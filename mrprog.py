...
'''
#Usage	Linux OS= Open Terminal and type (python3 mrprog.py)    	Windows(Install python3 and double click it)
'''
Version of Script: 1.1.0
'''
...
import random
import requests
os.system("pkg install python-requests")
os.system("pkg install python-termcolor")
os.system("pkg install python-socks")
os.system("pkg install python-mechanize")
os.system("reset")
u1A= raw_input ("Please Enter Your Name : ")
os.system("reset")
print colored("Coded by MrProg", 'red')
  
print colored("t.me/PhoenixSecurity", 'blue')
print colored("t.me/Mr_Prog", 'green')


print("Wellcome",u1A,"")
print("[2]	Enter Security code")

u1B=raw_input ("Choose  : ")

if u1B == '2':
	os.system("clear")
	print("For Buy Sec Code (t.me/Mr_Prog)")
	system=raw_input ("Enter Security Code : ")
	if system == '124-mls':
		print colored("Done Thanks For Buy", 'yellow')
		
	else:
		os.system("python2 mrprog.py")
else:
	print("Please Type 2 ")
	os.system("python2 mrprog.py")
#Help function
		...
		if os.path.isfile(self.passwordsFile):
			with open(self.passwordsFile) as f:
				...
				if (passwordsNumber > 0):
					...
					print('File Password Khali ast Lotfan chizi be an ezafe konid')
